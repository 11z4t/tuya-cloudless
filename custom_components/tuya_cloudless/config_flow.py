...
# Local keys are exactly 16 lowercase hex characters (generated by pairing server
# as secrets.token_hex(8) = 16 hex chars).  Enforcing hex-only rejects printable
# but semantically invalid characters like '!' or spaces.
_LOCAL_KEY_RE = re.compile(r"^[0-9a-f]{16}$")
